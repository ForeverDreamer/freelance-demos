...
| [social-crawler](social-crawler/) | Scrapy + Playwright CDP attach across Facebook / Twitter / Instagram public profiles | Python, Scrapy, scrapy-playwright | 🟡 code ready |
